...
my_ems_board = openEMSstim.openEMSstim("/dev/tty.usbserial-1410",19200)
while 1:
    choice = int(raw_input("1 or 2? EMS with full intensity on that channel for 0.5 seconds"))
    my_ems_board.send(ems_command(choice,100,5000))
